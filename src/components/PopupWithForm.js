function PopupWithForm({popupType, height, popupTitle, children, buttonType, disabled, formButtonText, isOpen,
                           onClose, onSubmit}) {
    return (
        <div className={`popup popup_${popupType} ${isOpen && "popup_opened"}`}>
            <div className={`popup__content popup__content_height_${height}-fields`}>
                <form className="form" name={`form-${popupType}`} id={`form-${popupType}`} onSubmit={onSubmit}>
