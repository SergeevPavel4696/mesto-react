...
export default function Main({onEditAvatarClick, onEditProfileClick, onAddPlaceClick, onCardClick, cards,
        ...
        <main className="content">
            <section className="profile">
                ...
                <div className="profile__info">
                    ...
                    <p className="profile__info-about-myself">{currentUser.about}</p>
                </div>
